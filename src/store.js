...
const DEMO_DOCS = [
  {
    ...
    fields: {
      'Owner':       'Anil Deshmukh',
      'Passport No.':'P4820971',
      'Issued':      '02 Jun 2019',
      'Country':     'India',
      'Nationality': 'Indian',
    },
    expiresAt: new Date(Date.now() + 340 * 86400000).toISOString(),
    addedAt: new Date(Date.now() - 2 * 86400000).toISOString(),
    location: { room: 'Master Bedroom', cupboard: 'Cupboard A', folder: 'Blue Folder', pocket: 'Pocket 4' },
    fileData: null,
    encrypted: true,
  },
  {
    ...
    category: 'Vehicles',
    owner: 'member-1',
    tags: ['insurance', 'car', 'swift'],
    fields: {
      'Vehicle':     'Maruti Swift',
      'Policy No.':  'MH12-VEH-2023-0091',
      'Insurer':     'HDFC ERGO',
      'Issued':      '01 Apr 2023',
    ...
    location: { room: 'Study', cupboard: 'Filing Cabinet', folder: 'Vehicles', pocket: 'Pocket 1' },
    fileData: null,
    encrypted: true,
  },
  {
    ...
    category: 'Property',
    owner: 'member-1',
    tags: ['property', 'deed', 'flat'],
    fields: {
      'Property':    'Flat 402, Sunrise Apts',
      'Area':        '1,100 sq ft',
      'Registered':  '15 Jan 2017',
      'Value':       '₹68,00,000',
      'Sub-Registrar':'Pune District',
    },
    expiresAt: null,
    addedAt: new Date(Date.now() - 8 * 86400000).toISOString(),
    location: { room: 'Master Bedroom', cupboard: 'Cupboard A', folder: 'Blue Folder', pocket: 'Pocket 2' },
    fileData: null,
    encrypted: true,
  },
  {
    id: 'doc-4',
    title: "Driving Licence — Rohan",
    category: 'Vehicles',
    owner: 'member-3',
    tags: ['driving', 'licence', 'rohan'],
    fields: {
      'Owner':       'Rohan Deshmukh',
      'Number':      'MH12 20230098765',
      'Issued':      '14 Mar 2023',
      'Class':       'LMV',
      'Blood Group': 'B+',
    },
    ...
    location: { room: 'Master Bedroom', cupboard: 'Cupboard A', folder: 'Brown Folder', pocket: 'Pocket 1' },
    fileData: null,
    encrypted: true,
  },
  {
    ...
    location: { room: 'Study', cupboard: 'Filing Cabinet', folder: 'Medical', pocket: 'Pocket 1' },
    fileData: null,
    encrypted: false,
  },
  {
    id: 'doc-6',
    title: "Marksheet 2023 — Priya",
    category: 'Education',
    owner: 'member-2',
    tags: ['education', 'marksheet', 'priya'],
    fields: {
      'Student':     'Priya Deshmukh',
    ...
    expiresAt: null,
    addedAt: new Date(Date.now() - 3 * 3600000).toISOString(),
    location: { room: 'Study', cupboard: 'Filing Cabinet', folder: 'Education', pocket: 'Pocket 2' },
    fileData: null,
    encrypted: false,
  },
  {
    id: 'doc-7',
    title: "PUC Certificate — Swift",
    category: 'Vehicles',
    owner: 'member-1',
    tags: ['puc', 'certificate', 'swift'],
    fields: {
      'Vehicle':     'Maruti Swift DZire',
      'Reg. No.':    'MH12 AB 5678',
      'Issued':      '01 Mar 2024',
      'Centre':      'AutoTest Pune',
      'CO Level':    '0.3%',
    },
    expiresAt: new Date(Date.now() + 29 * 86400000).toISOString(),
    addedAt: new Date(Date.now() - 60 * 86400000).toISOString(),
    location: { room: 'Study', cupboard: 'Filing Cabinet', folder: 'Vehicles', pocket: 'Pocket 2' },
    fileData: null,
    encrypted: false,
  },
  {
    id: 'doc-8',
    title: "Bank Locker Key Receipt",
    category: 'Banking',
    owner: 'member-1',
    tags: ['bank', 'locker', 'hdfc'],
    fields: {
      'Bank':        'HDFC Bank',
      'Branch':      'Kothrud, Pune',
      'Locker No.':  'L-204',
    ...
    expiresAt: null,
    addedAt: new Date(Date.now() - 120 * 86400000).toISOString(),
    location: { room: 'Locker', cupboard: 'Bank Vault', folder: 'Important', pocket: 'Slot 1' },
    fileData: null,
    encrypted: true,
  },
];
...
const DEMO_MEMBERS = [
  { id: 'member-1', name: 'Anil Deshmukh',  role: 'Yourself · Owner', relation: 'Owner',  permission: 'owner',  initials: 'A', devices: ['Anil\'s iPhone 15'] },
  { id: 'member-2', name: 'Priya Deshmukh', role: 'Spouse',           relation: 'Spouse', permission: 'edit',   initials: 'P', devices: ['Priya\'s Pixel 8'] },
  { id: 'member-3', name: 'Rohan Deshmukh', role: 'Son',              relation: 'Son',    permission: 'read',   initials: 'R', devices: [] },
  { id: 'member-4', name: 'Sunita (Mother)', role: 'Parent',          relation: 'Parent', permission: 'upload', initials: 'S', devices: [] },
];

const DEMO_ACTIVITY = [
  { id: 'act-1', type: 'share',  text: 'Priya shared <b>Marksheet 2023</b>', time: Date.now() - 2 * 3600000,   docId: 'doc-6' },
  { id: 'act-2', type: 'expiry', text: '<b>Driving Licence</b> expires in 12 days',  time: Date.now() - 86400000,    docId: 'doc-4' },
  { id: 'act-3', type: 'backup', text: 'Backup completed — 8 files',         time: Date.now() - 2 * 86400000,  docId: null },
  { id: 'act-4', type: 'add',    text: 'Added <b>PUC Certificate — Swift</b>',time: Date.now() - 4 * 86400000, docId: 'doc-7' },
  { id: 'act-5', type: 'add',    text: 'Added <b>Health Insurance — Family</b>', time: Date.now() - 15 * 86400000, docId: 'doc-5' },
];

const DEMO_LOCATIONS = [
  {
    id: 'loc-1', room: 'Master Bedroom',
    cupboards: [
      { id: 'cup-1', name: 'Cupboard A', folders: [
        { id: 'fld-1', name: 'Blue Folder',  pockets: ['Pocket 1','Pocket 2','Pocket 3','Pocket 4'] },
        { id: 'fld-2', name: 'Brown Folder', pockets: ['Pocket 1','Pocket 2'] },
      ]},
    ]
  },
  {
    id: 'loc-2', room: 'Study',
    cupboards: [
      { id: 'cup-2', name: 'Filing Cabinet', folders: [
        { id: 'fld-3', name: 'Vehicles', pockets: ['Pocket 1','Pocket 2'] },
        { id: 'fld-4', name: 'Medical',  pockets: ['Pocket 1','Pocket 2'] },
        { id: 'fld-5', name: 'Education',pockets: ['Pocket 1','Pocket 2'] },
      ]},
    ]
  },
  {
    id: 'loc-3', room: 'Locker',
    cupboards: [
      { id: 'cup-3', name: 'Bank Vault', folders: [
        { id: 'fld-6', name: 'Important', pockets: ['Slot 1','Slot 2'] },
      ]},
    ]
  },
];
